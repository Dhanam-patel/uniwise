      ...
      <div className="max-w-7xl mx-auto">
          ...
          {steps.map((step, i) => {
            ...
            return (
              ...
              >
                <Link
                  to={step.path}
                  className="group block h-full rounded-lg border border-border bg-card p-6 shadow-sm transition hover:shadow-md hover:border-primary/50"
                >
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-md transition hover:bg-primary/90"
          >
          ...
          <Link
            ...
            className="inline-flex items-center justify-center rounded-lg border border-border bg-card px-6 py-3 text-sm font-semibold text-foreground transition hover:border-primary/50"
          >
